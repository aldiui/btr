                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input class="dropify" name="image" id="input-file-now" type="file"
                                                    data-height="350"
                                                    data-default-file="<?= base_url('assets/images/method/').$method['image'];?>">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="name" id="name" value="<?= $method['name'];?>">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="network" id="network" value="<?= $method['network'];?>">
                                        <small class="invalid-feedback">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input class="dropify" name="wallet_image" id="input-file-now"
                                                    ...
                                                    data-default-file="<?= base_url('assets/images/method/').$method['wallet_image'];?>">
                                                <small class=" text-danger">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="btn-group w-100" role="group"
                                            ...
                                            <input type="radio"
                                                class="btn-check <?= ($method['is_active'] == 1) ? "active" : "";?>"
                                            ...
                                            <input type="radio"
                                                class="btn-check <?= ($method['is_active'] == 0) ? "active" : "";?>"
