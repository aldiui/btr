...
<body>
    <span class="preheader">
        This is a confirmation of your successful withdrawal transaction. Your withdrawal request was processed and the
        funds have been transferred to your designated account.</span>
                                    ...
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <h3><?= $withdraw['no_transaction'];?></h3>
                                                    </td>
                                                    <td>
                                                        <h3 class="align-right"><?= dated($withdraw['created_at']);?>
                                                        </h3>
                                                    </td>
                                                </tr>
                                                <tr>
